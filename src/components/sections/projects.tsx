...
const PROJECTS: Project[] = [
  {
    ...
    tagline: "Adaptive learning paths driven by machine learning",
    ...
    architecture: [
      ...
      "Redis cache for session management and real-time leaderboards",
    ...
    challenges: [
      ...
      "Optimizing database queries for 10k+ concurrent users with sub-200ms response times",
    ...
    impact: [
      ...
      "2.5x improvement in learning speed for intermediate users",
      "Reduced support tickets by 60% through intelligent help suggestions",
    ],
    metrics: [
  ...
  },
  {
    ...
    impact: [
      "Zero data loss in 500K+ editing sessions",
      "Sub-50ms sync latency across global regions",
      "Adopted by 3 teams internally, replacing paid collaboration tools",
    ],
    metrics: [
